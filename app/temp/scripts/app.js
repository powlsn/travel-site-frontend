...
var onScrollFeatureItem = new _RevealOnScroll2.default((0, _jquery2.default)(".feature-item"), "80%");
var onScrollTestimonial = new _RevealOnScroll2.default((0, _jquery2.default)(".testimonial"), "60%");
      ...
      this.itemsToReveal.each(function () {
        ...
        new Waypoint({
          ...
          handler: function handler(direction) {
            ...
            (0, _jquery2.default)(_this).addClass("reveal-item--is-visible");
          },
          offset: _offset
        });
      });
    ...
    value: function createHeaderWaypoint() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          ...
          if (direction == "down") {
            (0, _jquery2.default)(_this.siteHeader).addClass("site-header--dark");
          } else {
            (0, _jquery2.default)(_this.siteHeader).removeClass("site-header--dark");
          }
        }
      });
    }
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    key: "events",
    value: function events(evt, args) {
      // open the modal
